...
Optimal-FS~\cite{opt} form a progression from hand-designed rules toward
...
ReAct~\cite{react}, VRA~\cite{vra}, and Optimal-FS~\cite{opt} fit thresholds or
...
network~\citep{ash}, a ReLU (rectified linear unit) convolutional premise. BLOOD instead reads transformation
